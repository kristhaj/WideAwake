...
greenLED = 1 #pin number of green LED
redLED = 2 #pin number of red LED

GPIO.setmode(GPIO.BOARD)#enables board pin numbering
GPIO.setmode(greenLED, GPIO.OUT)#sets which pin is to be used as output
